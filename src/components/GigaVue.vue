...
<template>
  <div :class="$style.wrapper">
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 364 476"
      :class="$style.gigavue">
      <g id="Page-1">
        <g id="tamagotchi">
          <path id="Shape"
          ...
          <path id="Combined-Shape-2" data-name="Combined-Shape" :class="$style.green"
